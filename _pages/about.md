...
My research lies at the intersection of computer architecture and electronic design automation, with a particular focus on architecture-level power modeling and scale-up interconnect architecture. My work has appeared in ISCA, HPCA, DAC, ICCAD, ASP-DAC, TCAD, and NeurIPS. A complete list of publications is available on my [Publications](/publications/) page and [Google Scholar](https://scholar.google.com/citations?user=O79FXLgAAAAJ&hl=en&oi=ao).
